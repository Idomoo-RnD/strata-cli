# Short-form, branded, music, trailer, and creator editing

> **Engine anchors.** A brand document overrides every grammar choice here -
> [brand.md](../../brand/brand.md). The 9:16 grid, safe lines and platform chrome are measured in
> [layouts.md](../../layouts.md); reframing footage is [video-editing.md](../../shoot/video-editing.md).
...
> packs, whoosh-on-every-cut) are the same family as [anti-slop.md](../../craft/anti-slop.md); run both.
...
- **Objective:** awareness, recall, consideration, explanation, conversion, entertainment, community, or retention
- **Audience state:** unaware, problem-aware, solution-aware, returning fan, or ready to act
- **Value exchange:** what the viewer gets immediately—emotion, information, proof, access, identity, or utility
- **Proof:** product use, result, demonstration, testimony, mechanism, authority, or social evidence
- **Brand role:** character, object, world, sponsor, payoff, or signature
...
| Objective | Opening priority | Middle priority | Ending priority |
|---|---|---|---|
| Awareness | Distinctive world, face, action, or tension | Emotional/visual association with brand | Memorable brand cue |
| Consideration | Problem, desire, or surprising mechanism | Demonstration, differentiation, proof | Product and next step |
| Conversion | Relevant need, offer, or result | Objection handling and concrete benefit | Clear CTA with readable hold |
| Launch | Newness and category orientation | Feature-to-benefit translation | Name, availability, action |
| Brand story | Human or cultural tension | Character, values expressed through action | Brand as earned resolution, not pasted logo |
...
Create variants around hypotheses, not arbitrary alternates:

- Hook: result-first vs problem-first vs character-first
- Proof: demonstration vs testimonial vs mechanism
- Pace: premium sustained vs native energetic
...
**Viewer promise:** the product solves a relevant problem and the evidence is understandable.

### Useful structures

- **Problem → mechanism → result → proof → action**
- **Result → how it works → objection → offer → action**
- **Comparison → decisive difference → demonstration → action**
- **Unbox → setup → use → result → verdict**
...
**Viewer promise:** an accurate experience of the title's genre, scale, character, and central tension without resolving the story.

### Distinguish the forms

- **Teaser:** sells a world, image, premise, tone, or question. It may withhold plot mechanics.
- **Trailer:** sells a more complete dramatic engine, characters, escalation, and release promise.
- **Spot:** delivers one focused claim or set-piece within a fixed placement.
- **Character or featurette piece:** sells relationship, performance, craft, or access.

### Build a trailer spine

1. **Signature entry:** a line, image, sound, or situation that belongs to this title.
2. **Orientation:** protagonist, world, desire, and enough genre context.
3. **Disruption:** the event or force that creates the movie's engine.
4. **Expansion:** relationships, obstacles, scale, comedy, fear, or wonder.
5. **Escalation:** increasing consequences and shortening information units.
6. **Turn or drop:** silence, tonal reversal, intimate line, or false ending.
7. **Final run:** strongest complementary beats without becoming plot summary.
8. **Title and button:** title, date/action, then an optional final joke, scare, image, or sonic signature.
...
- Comedy: include complete joke mechanics, not only reaction montages.
...
**Viewer promise:** the song acquires a visual performance, story, concept, or world that rewards musical repetition.

### Map the song before cutting

Create markers for:

- Intro and pickup
- Verses, pre-choruses, choruses, bridge, instrumental sections, breakdown, outro
- Downbeats, syncopations, fills, vocal breaths, lyric turns, drops, stops, and texture changes
- Repeated lyrics or motifs that invite visual development

### Choose the visual architecture

| Mode | Primary material | Editorial priority |
|---|---|---|
| Performance-led | Artist, band, choreography | Credible sync, presence, musical gesture |
| Narrative-led | Character and events | Story progression aligned with song structure |
| Concept-led | Visual rule, art direction, process | Motif evolution and formal surprise |
| Dance-led | Choreography and body | Phrase and spatial continuity |
| Hybrid | Performance + narrative/concept | Clear ratio and handoff between modes |
...
- Use match movement, graphic relations, and spatial handoffs to make conceptual transitions feel musical.
- Use off-beat cuts and held shots to create syncopation and surprise.
- Decide where narrative scenes require source sound or silence; the interruption must be structurally valuable.
- Protect lip sync, especially around speed changes and mixed frame rates.
...
**Viewer promise:** direct access to a useful, entertaining, or trusted voice with enough structure to sustain voluntary viewing.

### Creator and vlog grammar
...
### Essay, review, and commentary video

- Build a claim-evidence-warrant structure.
...
Use a flexible **hook → development → payoff → action/loop** model:

- **Hook:** deliver the tension, result, novelty, emotional state, or useful question. It must connect honestly to the rest.
- **Development:** add new value in each beat; remove repeated setup.
- **Payoff:** resolve the promised demonstration, joke, reveal, transformation, or answer.
- **Action or loop:** give a next step, memorable close, or visual/semantic return to the opening.
...
6. Re-time product, brand, payoff, and CTA.
7. Review on an actual phone-sized display with platform overlays simulated.
8. Create controlled hook or proof variants when testing is authorized.
...
| Source | Adaptation need | Do not merely |
|---|---|---|
| Film/trailer to vertical | New hook, reframed focal path, captions, shorter story unit | Center crop and add subtitles |
| Long-form interview to clip | Restore context, select one complete idea, truthful headline | Extract the most provocative sentence |
| Commercial to creator-style | Shift voice, proof, texture, and CTA into native behavior | Add jump cuts and emojis to the same ad |
| Landscape tutorial to short | Choose one outcome, show result early, preserve critical steps | Speed up the entire tutorial |
...
- Can a viewer state the promise after the opening?
- Does each beat add information, proof, emotion, or escalation?
- Is the brand/product/title integrated rather than attached?
- Is the payoff complete and proportional to the hook?
