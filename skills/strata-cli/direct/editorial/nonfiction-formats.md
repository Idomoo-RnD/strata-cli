...
> this skill builds - blueprints in [blueprints.md](../../make/blueprints.md), the talking-head path in
> [avatar.md](../../shoot/avatar.md). The factual-integrity rules below apply in full to **personalized**
> video: a viewer's own data on screen is a claim, and
> [personalization.md](../../engine/personalization.md) is how it gets there truthfully.
...
**Viewer promise:** a truthful, authored experience whose evidence, participants, and construction deserve care.

### Choose the dominant documentary mode

| Mode | Editorial center | Useful grammar | Main danger |
|---|---|---|---|
| Observational / vérité | Lived scenes and behavior | Duration, spatial continuity, natural sound | Imposing a plot unsupported by events |
| Expository / investigative | Claim, evidence, causal argument | Radio edit, documents, archive, graphics | Narration outruns or misstates evidence |
| Participatory | Filmmaker-subject interaction | Visible questions, process, reflexivity | Hiding the filmmaker's influence |
| Profile / biography | Character across time | Interview, archive, motif, contradiction | Hagiography or reduction to milestones |
| Archival | Historical material as primary scene source | Chronology, source sound, contextual bridges | Wallpaper, anachronism, false attribution |
| Essay / poetic | Idea, voice, association | Counterpoint, montage, repetition, text | Ambiguity used to evade factual responsibility |
| Issue / advocacy | Persuasion grounded in evidence | Testimony, data, cases, counterargument | Withholding material context or flattening people into examples |

### Discovery and paper edit

1. Log all material with source, date, location, people, rights status, content, emotion, and reliability notes.
2. Transcribe interviews with speaker and source timecode. Preserve links from paper edit to source.
3. Build character, theme, event, evidence, contradiction, and visual-motif string-outs.
...
- What power does the production have over each participant, and what harm could this edit create?
...
**Viewer promise:** a human voice becomes concise and credible without feeling fabricated.

### Build the radio edit

- Identify the audience's opening question and the speaker's most credible answer.
...
### Testimonial-specific integrity

- Verify claims and required disclosures with the responsible stakeholder.
- Do not splice praise into a statement more absolute than the participant intended.
- Avoid generic success montage that implies documented outcomes the footage does not prove.
- For regulated products or consequential claims, preserve approved language and route changes for compliance review.

## News and current affairs

**Viewer promise:** due accuracy, clear attribution, appropriate context, and speed without manipulation.

### Editorial hierarchy

1. Accuracy and source verification
2. Context and fair attribution
3. Comprehension
4. Timeliness
5. Style
...
- Never add dramatic sound effects to factual event footage as if they were recorded there.
- Retain graphic source citations for contested figures and documents.

### Current-affairs and investigation

- Separate verified fact, allegation, response, analysis, and unanswered question.
- Give material responses sufficient context; do not use a weak or partial clip to simulate fairness.
- Re-check every juxtaposition involving a named person, alleged conduct, archival image, or anonymous source.
- Keep a correction path and version history for updates.
...
**Viewer promise:** the audience understands, remembers, and can act on the essential information.

### Choose the instructional objective

Name the required outcome as one of:
...
**Viewer promise:** a comprehensible game, social system, or lived situation with character-driven tension.
...
**Viewer promise:** the audience understands the contest and feels the human stakes.

### Live highlight or recap

- Establish teams/athletes, score, time, stage, and stakes.
- Select tent-pole plays first: scores, lead changes, decisive errors, injuries, tactical shifts, records, and final result.
- Preserve enough setup before each result to understand skill and causality.
- Use replays to reveal technique, contact, or controversy; do not repeat every event by habit.
- Let commentary and natural crowd sound carry authenticity. Use music around, not over, essential event sound.
- Include reactions after the play when they belong to the event and reveal consequence.
- Clearly label material from other dates, seasons, or contexts.
...
Use the narrative-genre guidance too. The decisive play should resolve a character or tactical question, not only add spectacle.
...
**Viewer promise:** access to the event's meaning, performance, and atmosphere without losing continuity.

- Build from the clean program audio or performance backbone.
- Establish venue and participant relationships, then cut to the active source of attention.
- For talks, cut to slides or demos when referenced and return to the speaker for emphasis, personality, or transitions.
...
Before lock, review every consequential sequence with this table:

| Question | Evidence to retain |
|---|---|
| What actually happened, in what order? | Factual chronology and source timecodes |
| What does the cut imply? | Sequence transcript and picture description |
| Which material is illustrative rather than evidentiary? | Labels and source metadata |
| Did dialogue trimming change meaning or certainty? | Before/after transcript |
| Are reactions contemporaneous? | Camera/source/date notes |
| Does music or sound editorialize beyond the evidence? | Dry viewing and mix notes |
| Are participants exposed to avoidable harm? | Consent/safety review |
