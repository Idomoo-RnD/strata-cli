...
file, [reference-styles.md](../craft/reference-styles.md) has ~25 signatures already reduced to tokens.
...
palette or its mark ([video-styles.md](../craft/video-styles.md) rule 1; a brand overrides everything).
...
2. **Secondary motion** — follow-through, counter-motion, ambient drift at ≤ 30 % of the primary,
   on a softer curve ([motion-design.md](../craft/motion-design.md) §5, counter-motion table).
...
Numbers come from [motion-design.md](../craft/motion-design.md) (emotion → motion, material → overshoot,
...
Each pass ends with the tells checklists ([anti-slop.md](../craft/anti-slop.md), [motion-design.md](../craft/motion-design.md)).
The rendered MP4 is reviewed after pass 4 ([review.md](../qa/review.md)); a must-fix sends the fix to
