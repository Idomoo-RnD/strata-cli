...
says how things *move* ([motion-design.md](../craft/motion-design.md), [motion-atlas.md](../craft/motion-atlas.md))
and how a frame is *composed* ([layouts.md](../layouts.md), [anti-slop.md](../craft/anti-slop.md)). This
...
- **The brief's own words and a brand document** — [brand.md](../brand/brand.md). Editorial grammar is
...
- **Anti-slop** — [anti-slop.md](../craft/anti-slop.md). These files name their own "failure modes";
...
6. **Apply a restrained grammar.** A small transition, sound, text and motion vocabulary; every
   recurring device has a meaning. (This is where [anti-slop.md](../craft/anti-slop.md) applies.)
