...
> token suggestion here - [brand.md](../../brand/brand.md) - and the personalized-data craft below is
> executed with layer-name keys and batch rows: [personalization.md](../../engine/personalization.md).
