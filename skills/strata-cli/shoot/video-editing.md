...
when the user says *"make this better"* — is [editing-director.md](../direct/editing-director.md);
...
[video-generation.md](clip-length.md#-a-clip-must-be--its-scene-slot--a-short-one-freezes-and-is-never-stretched).
...
([anti-slop.md](../craft/anti-slop.md)).
...
| "cut it to the music" | `strata beats` for onsets, then cut at those timestamps ([generative-fx.md](../craft/generative-fx.md)) |
