...
useful sanity number — it just is not the gap ([review.md](../qa/review.md)).
...
- **Brand consistency:** record the working music prompt in `.brand/brand.md`
  ([brand.md](../brand/brand.md)) so every video in a series shares one sonic identity — the audio
