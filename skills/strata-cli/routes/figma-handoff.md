...
**This is the route when** the brief names Figma: a file, a frame, a link, "the design". Against [brand-kit.md](brand-kit.md): a Figma file can also be the brand *source* (variables and tokens); then both routes apply and the brand document is built from it first.
...
## Watch for
- the frame origin not subtracted, everything offset: [figma.md](../brand/figma.md), *2. Convert coordinates*
- raw Figma names kept on layers: [figma.md](../brand/figma.md), *8. Names — this one breaks renders*
- an import shipped without motion: [figma.md](../brand/figma.md), *12. A faithful import is still a slideshow — add motion*
