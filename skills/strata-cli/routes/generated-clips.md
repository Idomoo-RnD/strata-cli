...
- [video-prompts.md](../shoot/video-prompts.md): *Shot budget by duration*, then the worked prompt nearest the clip's kind.
- [production-bible.md](../make/production-bible.md): when a person, product or set appears twice.
