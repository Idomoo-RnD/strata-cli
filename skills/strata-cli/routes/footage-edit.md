...
- [editorial/workflow-and-qa.md](../direct/editorial/workflow-and-qa.md): *Delivery and technical QC*; *Full-watch QC*.
- [workflow.md](../workflow.md): check B, an edit is not a design job.

## Watch for
- an edit that loses the clip's audio with a clean exit code: [video-editing.md](../shoot/video-editing.md), *The three rules that prevent most damage*
- a clip slowed to fill a slot: [video-editing.md](../shoot/video-editing.md), *Recipes for common asks*
