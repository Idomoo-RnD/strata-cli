...
**It expects** a data contract: which fields vary, and their extremes. **It delivers** one template scene rendered per row: the *Data story / KPI* row in [blueprints.md](../make/blueprints.md); **personalized-template**, **data-report** or **odometer-count** in [video-styles.md](../craft/video-styles.md).
...
- [motion/06-ui-data-brand.md](../craft/motion/06-ui-data-brand.md): *2. Data and infographic motion*.
- [editorial/nonfiction-formats.md](../direct/editorial/nonfiction-formats.md): *Shared factual integrity rules*.
...
- two layers sharing a name in different comps: [personalization.md](../engine/personalization.md), *The keys are LAYER NAMES*
- a Hebrew or Arabic value in a template proved only against Latin: [personalization.md](../engine/personalization.md), *Right-to-left values*
