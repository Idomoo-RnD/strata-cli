...
continuity instruction in it outranks my own craft defaults ([anti-slop.md](../craft/anti-slop.md)'s
...
| **A brand kit / `.brand/brand.md`** | the atoms | [brand.md](../brand/brand.md) — it governs everything below |
...
|---|---|---|
| **dialogue on camera** (someone visibly speaks) | `generate video --ref-image <sheet> --ref-audio <tts>` | lip-sync needs the audio reference; consistency comes from the sheet. The talking-person recipe: [video-generation-advanced.md](../shoot/ref-audio.md#--ref-audio--characters-that-speak-your-audio) |
...
| **end card / titles / lower-thirds / captions** | a **VASCO scene**, never generated | type is authored, not generated ([format.md](../format.md), [blocks.md](../engine/blocks.md)) |
